...
public class MBeansView extends VerticalLayout implements ClickListener, ViewStateChangedListener, View {
...
//		setSizeFull();
	...
	public void enter(ViewChangeListener.ViewChangeEvent event) {
		UiModel newModel = ((JmxConfigGeneratorUI) UI.getCurrent()).getUiModel();
		model = newModel;
