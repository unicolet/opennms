...
NOTE: http://karaf.apache.org/manual/latest/users-guide/console.html[documentation] on using the OSGi console embedded in OpenNMS and the relative http://camel.apache.org/karaf.html[camel commands].
